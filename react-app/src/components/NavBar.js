            ...
            <div className="navbar__grid-container">
                ...
                {authenticated ? (
                    <div className="navbar__grid">
                        <div className="navbar__div__dropdown-container">
                            <button className="navbar__button__dashboard">
                                Dashboard
                                <img
                                    alt="downarrow"
                                    className="navbar__img__down-arrow"
                                    src="https://image.flaticon.com/icons/png/512/19/19967.png"
                                    width="10"
                                    height="10"
                                />
                            </button>
                ...
                {authenticated ? (
                    <div className="navbar__logout-button">
                        <div>
                            <img
                                className="navbar__img__running"
                                src="https://i.gifer.com/7QUq.gif"
                                width="120"
                                height="120"
                            />
                        </div>
